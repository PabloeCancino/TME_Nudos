...
\textbf{Verificación en Lean 4:}\\
El archivo \texttt{Reidemeister.lean} contiene el enunciado formal completo del
teorema (\texttt{reidemeister\_theorem}). Las propiedades algebraicas de los
movimientos R1 y R2 y la dirección de \emph{soundness} (si relacionados por
movimientos \(\to\) equivalentes topológicamente) están estructuradas como
teoremas. La dirección de \emph{completitud} (si equivalentes topológicamente
\(\to\) relacionados por movimientos) se adopta como axioma fundamental, dado
que requiere herramientas de topología diferencial fuera del alcance de la
...
\subsubsection{\texorpdfstring{\textbf{Nota 4.1 --- Realizabilidad y
Axiomas
A1-A4}}{Nota 4.1 --- Realizabilidad y Axiomas A1-A4}}\label{nota-4.1-realizabilidad-y-axiomas-a1-a4}
