...
\textbf{Teorema Órbita-Estabilizador (K₃).}\\
Usamos como ejemplo la configuración modular K₃ con 3 cruces.
...
La clasificación completa de configuraciones K₃ revela una estructura combinatoria
...
\item
  \textbf{Configuraciones K₃ válidas}: \(\frac{6!}{3!} = \frac{720}{6} = 120\)
...
De las 120 configuraciones modulares K₃ que satisfacen los axiomas A1-A4:
\begin{itemize}
\tightlist
\item
...
\tightlist
\item
  ✅ \textbf{Para K₃ irreducibles}: Caracterización \textbf{completa} de
